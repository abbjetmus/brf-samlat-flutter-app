...
class CreatePlacePage extends CompositionWidget {
  ...
  Widget Function(BuildContext) setup() {
    ...
    Future<void> createPlace() async {
      ...
      loading.value = true;
      final success = await placesStore.createPlace(
      ...
      if (context != null && context.mounted) {
        if (success) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text('Lokal skapad!'),
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Kunde inte skapa lokal.'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            FilledButton(
              onPressed: loading.value ? null : createPlace,
              child: loading.value
                  ? const SizedBox(
                      height: 20,
                      width: 20,
